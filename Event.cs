...
protected class Event
{
    ...
    string FullDetails(string Title,int capacity, string Weather,string RSVPemail, string speaker, string Description, string date, string time, string address, string eventtype)
    {Title = EventTitle;
    Description = EventDescription;
    date = Date;
    time = Time;
    ...
    string ShortDescription (string Title, string eventtype, string date)
    {date = Date;
    Title = EventTitle;
    eventtype = EventType;
